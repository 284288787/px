...
public class CommonConstants {
  ...
  public enum UserType {
    system(1, ""), franchisee(2, "加盟商"), coach(3, "教练"), salesman(4, "业务员"), customer(5, "客户");

    private int userType;
    private String caption;

    private UserType(int userType, String caption) {
  ...
  public enum SmsTag {
    registration(-1, "注册"), findpassword(-2, "找回密码"), bindMobile(1, "绑定手机"), apply(2, "培训项目报名");

...
//			}
		...
		if (orderDTO.getPayType().intValue() == 2) {
			...
			PayReqData prd = new PayReqData(orderDTO.getSubject(), orderDTO.getOrderNo(), orderDTO.getOrderNo(), orderDTO.getTotalMoney(), orderDTO.getCreateTime(), const1.getAppId(), const1.getKey(), const1.getMchId(), const1.getNotifyUrl(), const1.getServerIp(), const1.getTradeType(), orderDTO.getOpenId());

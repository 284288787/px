...
@Configuration
//@EnableWebMvc
@ComponentScan(basePackages = {"com.booting.**.controller"}, useDefaultFilters = false, includeFilters = {
...
public class MvcConfig extends WebMvcConfigurationSupport{
    ...
    protected void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("MP_verify_CwvsHjk3WzPkyA9Q.txt")
        		.addResourceLocations("classpath:/");
        registry.addResourceHandler("/webjars/**")
        		.addResourceLocations("classpath:/META-INF/resources/webjars/");
        
        registry.addResourceHandler("/px/**", "/bui/**", "/static/**", "/swagger/**", "/favicon.ico")
        .addResourceLocations("/px/", "/bui/", "/static/", "/swagger/", "/");
        		;
    }

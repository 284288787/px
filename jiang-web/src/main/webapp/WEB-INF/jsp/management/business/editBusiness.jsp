...
<body>
	<div class="edit-container">
		<form action="" id="editBusinessForm">
		<input type="hidden" name="businessId" value="${business.businessId}">
		<ul>
			<li><strong>行业名称：</strong><span><input type="text" name="businessName" placeholder="行业名称，必填" value="${business.businessName}"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/business/editBusiness.js"></script>
</body>
</html>
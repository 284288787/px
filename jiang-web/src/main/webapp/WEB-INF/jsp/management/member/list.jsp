...
<body> 
	<div class="main-container" id="main-container"> 
		<div class="search-container"> 
			<form action="${basePath}" id="queryForm"> 
				...
				<a onclick="memberHandle.query()" class="button blue">查询</a> 
				<a onclick="memberHandle.reset()" class="button grey">清空</a> 
			</form>
		</div> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/member/list.js"></script>
</body>
</html>
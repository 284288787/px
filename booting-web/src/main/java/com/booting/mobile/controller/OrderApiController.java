...
public class OrderApiController extends ApiBaseController{
	...
	@ApiImplicitParams({
		...
		@ApiImplicitParam(name = "type", value = "订单类型 1购买套餐 2订场地 3优惠券", paramType = "query", required = true, dataType = "Integer", allowableValues = "1,2"),
		...
		@ApiImplicitParam(name = "details", value = "商品明细 [{productId:'1',productType:'1',quantity:'1'},{productId:'2',productType:'1',quantity:'2'}] productId(购买的产品Id), productType(产品类型 1套餐), quantity(购买数量)", paramType = "query", required = true, dataType = "json"),
	})

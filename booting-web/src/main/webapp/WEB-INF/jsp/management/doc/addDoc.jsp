...
<body>
	<div class="edit-container">
		...
		<input type="hidden" name="logo">
			<div class="line"><strong>资讯类型：</strong><span><select name="type"><option value="1">轮播图</option><option value="2">文章</option></select></span></div>
			<div class="line"style="display:none"><strong>资讯位置：</strong><span><select name="position"><option value="1">正常</option><option value="2">置顶</option></select></span></div>
			<div class="line"><strong>资讯标题：</strong><span><input type="text" class="ipt400" name="title" placeholder="资讯标题，必填"></span></div>
			<div class="line"><strong>资讯简介：</strong><span><input type="text" class="ipt400" name="intro" placeholder="资讯简介"></span></div>
			<div class="photoDiv">
				<strong>轮播图片：</strong><img src="${basePath}static/images/uploadBtn.png" id="uploadBtn"> <img style="display:none" width="70px" height="70px">
			</div>
			<div class="contentDiv"><strong>资讯URL：</strong><span><input type="text" class="ipt700" name="content" placeholder="资讯URL，选填"></span></div>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/doc/addDoc.js?3"></script>
	...
	$(function(){
		...
		$("select[name=type]").change(function(){
			...
			if(val==2){
				...
				$(".contentDiv").html('<strong>资讯URL：</strong><span><input type="text" class="ipt700" name="content" placeholder="资讯URL，必填"></span>');

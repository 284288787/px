...
<body>
	<div class="edit-container">
		...
		<ul>
			<li class=""><strong class="red-word">球队：</strong><span class="black-word">${team.teamName}</span></li>
			...
			<li class="service"><strong>使用数量：</strong><span><input type="text" teamId="${team.teamId}" class="useServiceNum" placeholder="填0或不填表示本次不使用"></span></li>
		</ul>
		<br>
		</form>
		<div class="btnGroup">
	...
	<input id="subjectId" type="hidden" value="${team.teamId}">

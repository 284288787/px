...
<body>
	<div class="edit-container">
		<form action="" id="editSiteForm">
		<input type="hidden" name="courtId" id="courtId">
		<ul>
			<li><strong>所属球场：</strong><span id="courtName"></span></li>
			<li><strong>场地名称：</strong><span><input type="text" name="siteName" placeholder="场地名称，必填"></span></li>
			<li><strong>场地规格：</strong><span><select name="specification">
				<option value="">请选择</option>
				<option value="1">11人制</option>
				<option value="2">8人制</option>
			</select></span></li>
			<li><strong>是否分隔：</strong><span><input type="radio" name="knifing" id="knifing1" value="1"><label for="knifing1">是</label><input type="radio" name="knifing" id="knifing2" value="0"><label for="knifing2">否</label></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/court/addSite.js?2"></script>
</body>
</html>
	...
	<div class="main-container" id="main-container">
		<div class="search-container">
			<form action="${basePath}" id="queryForm">
				<span>球场名称：<input type="text" name="courtName" placeholder="请输入要查找的球场名称"></span>
				<span>是否可用：<select name="enabled"><option value="">全部</option><option value="1">可用</option><option value="0">禁用</option></select> </span>
				<a onclick="courtHandle.query()" class="button blue">查询</a>
				<a onclick="courtHandle.reset()" class="button grey">清空</a>
			</form>
		</div>
		<div class="data-container">
				<div class="btnGroup">
				<a onclick="courtHandle.addNew()" class="button grey">新增</a>
				<a onclick="courtHandle.enabled()" class="button blue">启用</a>
				<a onclick="courtHandle.disabled()" class="button yellow">禁用</a>
<!-- 				<a onclick="courtHandle.remove()" class="button red">删除</a> -->
				</div>
	...
	<script type="text/javascript" src="${basePath}static/js/management/court/courtList.js?3"></script>
</body>
</html>
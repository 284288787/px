...
<body>
	<div class="edit-container">
		...
		<ul>
			<li><strong>行业名称：</strong><span><input type="text" name="businessName" placeholder="行业名称，必填"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/business/addBusiness.js"></script>
</body>
</html>
...
<body>
	...
	<c:if test="${errorCode==1}">该用户不能成为球队管理员，请联系管理员</c:if>
...
<!-- 			</span></li> -->
	...
	<script type="text/javascript" src="${basePath}static/js/management/member/becomeEnterprise.js"></script>
</body>
</html>
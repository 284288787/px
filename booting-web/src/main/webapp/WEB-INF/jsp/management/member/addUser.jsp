...
<body>
	<div class="edit-container">
		...
		<ul>
			...
			<li><strong>帐号：</strong><span><input type="text" name="account" placeholder="帐号即为手机号"></span></li>
			<li><strong>设置密码：</strong><span><input type="password" id="password" name="password" placeholder="密码"></span></li>
			<li><strong>确认密码：</strong><span><input type="password" name="password2" placeholder="确认密码"></span></li>
			<li><strong>地址：</strong><span><input type="text" name="address" class="ipt300" placeholder="地址"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/member/addUser.js?1"></script>
</body>
</html>
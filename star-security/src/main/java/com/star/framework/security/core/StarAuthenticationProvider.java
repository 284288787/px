/**create by liuhua at 2017年5月31日 上午10:24:44**/
...
@Service
public class StarAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        // [2] 使用用户名从数据库读取用户信息
        UserDetails userDetails = securtityUserServiceDetails.loadUserByUsername(token.getName());
        // [3] 检查用户信息
        if(userDetails == null) {
...
//            if(!passwordEncoder.isPasswordValid(inputPassword, encryptedPassword, null)) {
//                throw new BadCredentialsException("用户名/密码无效");
//            }
        }

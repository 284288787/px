...
//		Tree tree = (Tree)executeMethod("com.star.framework.common.util.CustomMadeMenuTree@test");
//		System.out.println(tree.getRootNode().getNodeName());
		Object object = getObjectByStaticMethod("com.star.framework.system.cache.AreaTree");

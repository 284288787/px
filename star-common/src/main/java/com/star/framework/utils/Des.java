...
public class Des {
    ...
    public static void main(String[] args) {
        Des desObj = new Des();
        String key1 = "u1UHSRP~=tY7MDVEMUKg89q9-sgBOA!w";
        String key2 = "e52BvGo,~Xr1+)h*]^.pX9n(";
        String key3 = "-6%MTQrCZuSJ2Z@in)6+xV!Y8ZCSk+MB";
        String data = "{username: '18610925630', passwd: '123123'}";
    ...
    /*
     * encrypt_args the string to string made up of hex return the encrypted string
     */

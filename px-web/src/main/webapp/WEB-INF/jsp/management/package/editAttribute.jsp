...
<body>
	<div class="edit-container">
		...
		<ul>
			<li><strong>属性名称：</strong><span><input type="text" name="attributeName" placeholder="属性名称" value="${attribute.attributeName}"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/package/editAttribute.js?2"></script>
</body>
</html>
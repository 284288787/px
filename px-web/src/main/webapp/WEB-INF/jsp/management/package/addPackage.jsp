...
<body>
	<div class="edit-container">
		...
		<ul>
			<li><strong>套餐ID：</strong><span><input type="text" name="packageId" placeholder="套餐ID，不要和其他重复"></span></li>
			<li><strong>套餐类型：</strong><span>
			...
			<li><strong>套餐名称：</strong><span><input type="text" name="packageName" placeholder="套餐名称"></span></li>
			<li><strong>套餐描述：</strong><span><input type="text" name="description" placeholder="套餐描述"></span></li>
			<li><strong>套餐价格：</strong><span><input type="text" name="price" placeholder="套餐价格"></span></li>
			<li><strong>套餐折扣：</strong><span><input type="text" name="discount" placeholder="没有折扣不填，如：8.8"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/package/addPackage.js?3"></script>
</body>
</html>
...
<body>
	<div class="edit-container">
		...
		<ul>
			<li><strong>服务名称：</strong><span><input type="text" name="serviceName" placeholder="服务名称" value="${service.serviceName}"></span></li>
			<li><strong>服务说明：</strong><span><input type="text" name="description" placeholder="服务描述" value="${service.description}"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/package/editService.js?2"></script>
</body>
</html>
	...
	<div class="main-container" id="main-container">
		<div class="search-container">
			<form action="${basePath}" id="queryForm">
				<span>服务名称：<input type="text" name="serviceName" placeholder="请输入要查找的服务名称"></span>
...
<!-- 				<span>是否锁定：<select name="nonLocked"><option value="">全部</option><option value="1">未锁定</option><option value="0">已锁定</option></select> </span> -->
				...
				<a onclick="serviceHandle.query()" class="button blue">查询</a>
				<a onclick="serviceHandle.reset()" class="button grey">清空</a>
			</form>
		</div>
		<div class="data-container">
				<div class="btnGroup">
				<a onclick="serviceHandle.addNew()" class="button grey">新增</a>
				<a onclick="serviceHandle.enabled()" class="button blue">启用</a>
				<a onclick="serviceHandle.disabled()" class="button yellow">禁用</a>
<!-- 				<a onclick="userHandle.remove()" class="button red">删除</a> -->
	...
	<script type="text/javascript" src="${basePath}static/js/management/package/serviceList.js?1"></script>
</body>
</html>
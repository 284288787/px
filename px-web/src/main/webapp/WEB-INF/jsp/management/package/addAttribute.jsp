...
<body>
	<div class="edit-container">
		<form action="" id="editAttributeForm">
		<ul>
			<li><strong>属性ID：</strong><span><input type="text" name="attributeId" placeholder="属性Id，不要和其他的重复"></span></li>
			<li><strong>属性名称：</strong><span><input type="text" name="attributeName" placeholder="属性名称"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/package/addAttribute.js?2"></script>
</body>
</html>
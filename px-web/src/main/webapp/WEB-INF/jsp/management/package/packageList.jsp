	...
	<div class="main-container" id="main-container">
		<div class="search-container">
			<form action="${basePath}" id="queryForm">
				<span>套餐名称：<input type="text" name="packageName" placeholder="请输入要查找的套餐名称"></span>
...
<!-- 				<span>是否锁定：<select name="nonLocked"><option value="">全部</option><option value="1">未锁定</option><option value="0">已锁定</option></select> </span> -->
				...
				<a onclick="packageHandle.query()" class="button blue">查询</a>
				<a onclick="packageHandle.reset()" class="button grey">清空</a>
			</form>
		</div>
		<div class="data-container">
				<div class="btnGroup">
				<a onclick="packageHandle.addNew()" class="button grey">新增</a>
				<a onclick="packageHandle.enabled()" class="button blue">启用</a>
				<a onclick="packageHandle.disabled()" class="button yellow">禁用</a>
<!-- 				<a onclick="packageHandle.remove()" class="button red">删除</a> -->
				</div>
	...
	<script type="text/javascript" src="${basePath}static/js/management/package/packageList.js?5"></script>
</body>
</html>
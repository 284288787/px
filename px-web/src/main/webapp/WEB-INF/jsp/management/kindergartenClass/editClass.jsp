...
<body>
	<div class="edit-container"> 
		...
		<input type="hidden" name="schoolId" value="${classDTO.schoolId}">
		<input type="hidden" name="teacherId" value="${classDTO.teacherId}">
		<ul> 
			<li><strong>班级名称：</strong><span><input type="text" name="name" placeholder="班级名称" value="${classDTO.name}"></span></li>
			<li><strong>幼儿园：</strong><span><input type="text" name="schoolName" placeholder="选择幼儿园" value="${classDTO.schoolName}" readonly></span></li>
			<li><strong>班主任：</strong><span><input type="text" name="teacherName" placeholder="选择班主任" value="${classDTO.teacherName}" readonly></span></li>
			<li><strong>班主任电话：</strong><span><input type="text" name="teacherMobile" placeholder="班主任电话" value="${classDTO.teacherMobile}" readonly></span></li>
			<li style="height:120px;"><strong>简介：</strong><span> 
				<textarea rows="1" cols="1" style="width:700px; height:80px;" name="intro" placeholder="简介">${classDTO.intro}</textarea>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/kindergartenClass/editClass.js"></script> 
</body>
</html>
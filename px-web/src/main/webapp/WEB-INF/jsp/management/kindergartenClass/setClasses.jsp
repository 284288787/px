...
<body> 
	...
	<input id="classIdsByHeadTeacher" type="hidden" value="${classIdsByHeadTeacher}">
	...
	var chooseHandle = new ListHandle({ 
		...
		primaryKey: 'classId',
		urls:{ 
			list: basePath+'class/list?schoolId='+args.schoolId,//列表
		}
	},{ 
		choose: function(){
			var ids = chooseHandle.getIds();
			var params = {schoolId: args.schoolId, teacherId: args.teacherId, classIds: ids};
			$.ajax({

...
<body> 
	<div class="main-container" id="main-container"> 
		<div class="search-container"> 
			<form action="${basePath}" id="queryForm"> 
				<span>报名项：<input type="text" name="itemName" placeholder="输入报名项" > </span> 
				<span>是否可用：<select name="enabled"><option value="">全部</option><option value="1" >可用</option><option value="0" >禁用</option></select> </span> 
				<a onclick="applyItemHandle.query()" class="button blue">查询</a> 
				<a onclick="applyItemHandle.reset()" class="button grey">清空</a> 
			</form>
		</div> 
		<div class="data-container"> 
				<div class="btnGroup"> 
				<a onclick="applyItemHandle.addNew()" class="button grey">新增</a>
				<a onclick="applyItemHandle.enabled()" class="button blue">启用</a> 
				<a onclick="applyItemHandle.disabled()" class="button yellow">禁用</a>
				<a onclick="applyItemHandle.remove()" class="button yellow">删除</a>
				</div> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/applyItem/list.js"></script>
</body>
</html>
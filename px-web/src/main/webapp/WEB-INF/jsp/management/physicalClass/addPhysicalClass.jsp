...
<body>
	<div class="edit-container"> 
		...
		<ul> 
			<li><strong>课程标题：</strong><span><input type="text" class="ipt300" name="title" placeholder="课程标题" ></span></li>
			<li><strong>上课时间：</strong><span><input type="text" id="schoolTime" name="schoolTime" placeholder="上课时间" class="Wdate" onclick="WdatePicker({isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"></span></li>
			<li><strong>报名截止时间：</strong><span><input type="text" name="deadlineTime" placeholder="不填则至上课时间截止报名" class="Wdate" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'schoolTime\')}',isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm:ss'})"></span></li>
			<li><strong>价格：</strong><span><input type="text" name="price" placeholder="价格" ></span></li>
			<li><strong>上课地点：</strong><span><input type="text" class="ipt400" name="address" placeholder="上课地点" ></span></li>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/physicalClass/addPhysicalClass.js"></script> 
</body>
</html>
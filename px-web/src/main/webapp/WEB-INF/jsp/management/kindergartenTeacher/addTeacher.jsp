...
<body>
	<div class="edit-container"> 
		...
		<ul> 
			<li><strong>幼儿园：</strong><span><input type="text" name="schoolName" placeholder="幼儿园" readonly><input type="hidden" name="schoolId"></span></li>
			...
			<li><strong>姓名：</strong><span><input type="text" name="teacherName" placeholder="姓名" ></span></li>
			<li><strong>电话：</strong><span><input type="text" name="teacherMobile" placeholder="电话" ></span></li>
			<li style="height:90px;"><strong>简介：</strong><span> 
				<textarea rows="1" cols="1" style="width:800px; height:80px;" name="intro" placeholder="简介"></textarea>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/kindergartenTeacher/addTeacher.js?1"></script> 
</body>
</html>
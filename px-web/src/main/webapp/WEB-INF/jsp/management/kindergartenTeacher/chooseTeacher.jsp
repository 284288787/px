...
<body>
	<div class="edit-container">
		...
		<c:forEach items="${teachers}" var="teacher">
					<li dataId="${teacher.teacherId}" dataMobile="${teacher.teacherMobile}">${teacher.teacherName}</li>
		</c:forEach>
				</ul>
			</div>
		</div>
	...
	$(function(){
		...
		$("li").click(function(){
			...
			var dataMobile=$(this).attr("dataMobile");
			var choosedName=$.trim($(this).text());
			opts.callback(choosedId, choosedName, dataMobile);
			art.dialog.close();
		});
	});
	</script>

...
<body>
	<div class="main-container" id="main-container">
		<div class="search-container">
			<form action="${basePath}" id="queryForm">
				<span>级别：<input type="text" name="level" placeholder="级别，例如：2"></span>
				<a onclick="levelHandle.query()" class="button blue">查询</a>
				<a onclick="levelHandle.reset()" class="button grey">清空</a>
			</form>
		</div>
		<div class="data-container">
				<div class="btnGroup">
				<a onclick="levelHandle.addNew()" class="button grey">新增</a>
				<a onclick="levelHandle.remove()" class="button red">删除</a>
				</div>
	...
	<script type="text/javascript" src="${basePath}static/js/management/bracelet/pointLevelList.js?1"></script>
</body>
</html>
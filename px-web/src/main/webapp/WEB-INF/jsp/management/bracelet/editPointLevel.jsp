...
<body>
	<div class="edit-container">
		...
		<input type="hidden" name="id" value="${pointLevelDTO.id}">
		<table class="gy_table">
				<tr>
					<td class="alignright" width="150px"><strong>级别：</strong></td>
					<td><input type="text" name="level" class="ipt100" placeholder="级别，例如：3" maxlength="3" value="${pointLevelDTO.level}" readonly></td>
				</tr>
				<tr>
					<td class="alignright"><strong>称号：</strong></td>
					<td><input type="text" name="name" placeholder="称号" maxlength="10" value="${pointLevelDTO.name}"></td>
				</tr>
				<tr>
					<td class="alignright"><strong>图标：</strong></td>
					<td>
					<img src="${basePath}${pointLevelDTO.icon}" id="uploadBtn" height="72px" width="72px">
					<input type="hidden" name="icon" value="${pointLevelDTO.icon}">
					</td>
				</tr>
				<tr>
					<td class="alignright"><strong>升级所需经验(点)：</strong></td>
					<td><input type="text" name="pointStep" class="ipt100" placeholder="例如：1000" maxlength="8" value="${pointLevelDTO.pointStep}"></td>
				</tr>
				<tr>
					<td class="alignright"><strong>每次增长经验(点)：</strong></td>
					<td><input type="text" name="point" class="ipt100" placeholder="例如：10" maxlength="5" value="${pointLevelDTO.point}"></td>
				</tr>
				<tr>
					<td class="alignright"><strong>每次增长经验所需卡路里(小卡)：</strong></td>
					<td><input type="text" name="calorieStep" class="ipt150" placeholder="例如：1000" maxlength="8" value="${pointLevelDTO.calorieStep}"></td>
				</tr>
				<tr>
					<td class="alignright"><strong>每次增长经验所需距离(m)：</strong></td>
					<td><input type="text" name="distanceStep" class="ipt150" placeholder="例如：1000" maxlength="8" value="${pointLevelDTO.distanceStep}"></td>
				</tr>
				<tr>
					<td colspan="2">
						<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/bracelet/editPointLevel.js"></script>
</body>
</html>
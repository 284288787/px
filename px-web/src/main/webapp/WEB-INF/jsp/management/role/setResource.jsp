...
<body>
	<div class="main-container" id="main-container">
		...
		<div class="data-container">
			<div class="btnGroup">
				<a onclick="rsHandle.setRole()" class="button grey" id="enterBtn">确认分配给角色</a>
			</div>
	...
	var rsHandle = new ListHandle({
		...
		primaryKey: 'sourceId',
		urls:{
			list: basePath+'role/setResource/'+params.roleId,        //列表
		}
	},{
		setRole: function(){
			var ids = rsHandle.getIds();
			$.ajax({
				url: basePath+'role/saveSourceRelation',
				data: {roleId: params.roleId, sourceIds: ids},
				type: 'post',
				dataType: 'json',
	...
	$(function(){
		$("#enterBtn").text("确认分配给角色 " + params.name);
		var colNames = ['roleId', 'sourceId', '资源名称', '资源类型', '父级资源', '资源说明', '资源链接'];
		var colModel = [
			{name: 'roleId', index: 'roleId', hidden: true},
			{name: 'sourceId', index: 'sourceId', hidden: true},

...
<body>
	<div class="edit-container">
		...
		<ul>
			<li><strong>角色编码：</strong><span><input type="text" name="roleName" placeholder="角色编码，必填" value="${role.roleName}"></span></li>
			<li><strong>角色名称：</strong><span><input type="text" name="roleRemark" placeholder="角色名称，必填" value="${role.roleRemark}"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/role/editRole.js?1"></script>
</body>
</html>
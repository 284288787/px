...
<body>
	<div class="edit-container"> 
		<form action="" id="editStudyAddressForm"> 
		<input type="hidden" name="addrId" value="${studyAddressDTO.addrId}">
		<ul> 
			<li><strong>校区名：</strong><span><input type="text" name="addrName" placeholder="校区名" value="${studyAddressDTO.addrName}"></span></li>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/studyAddress/editStudyAddress.js"></script> 
</body>
</html>
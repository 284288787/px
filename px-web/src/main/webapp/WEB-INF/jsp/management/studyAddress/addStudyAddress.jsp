...
<body>
	<div class="edit-container"> 
		...
		<ul> 
			<li><strong>校区名：</strong><span><input type="text" name="addrName" placeholder="校区名" ></span></li>
			<li><strong>在前端：</strong><span>
        <select name="viewFront">
	...
	<script type="text/javascript" src="${basePath}static/js/management/studyAddress/addStudyAddress.js"></script> 
</body>
</html>
	...
	<div class="main-container" id="main-container"> 
		<div class="search-container"> 
			<form action="${basePath}" method="post" id="queryForm"> 
				...
				<a onclick="kindergartenCoachHandle.query()" class="button blue">查询</a> 
				<a onclick="kindergartenCoachHandle.reset()" class="button grey">清空</a> 
			</form>
		</div> 
		<div class="data-container"> 
				<div class="btnGroup"> 
				<a onclick="kindergartenCoachHandle.addNew()" class="button grey">新增</a>
				<a onclick="kindergartenCoachHandle.enabled()" class="button blue">启用</a> 
				<a onclick="kindergartenCoachHandle.disabled()" class="button yellow">禁用</a>
				<a onclick="kindergartenCoachHandle.remove()" class="button yellow">删除</a>
<!-- 				<a onclick="kindergartenCoachHandle.exportModel()" class="button red">导出模板</a> -->
<!-- 				<a onclick="kindergartenCoachHandle.importData()" class="button red">导入教练信息</a> -->
				</div> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/kindergartenCoach/list.js"></script>
</body>
</html>
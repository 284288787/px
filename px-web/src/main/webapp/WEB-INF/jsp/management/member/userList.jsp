...
<!-- 				<span>是否锁定：<select name="nonLocked"><option value="">全部</option><option value="1">未锁定</option><option value="0">已锁定</option></select> </span> -->
				...
				<span>身份：<select name="identity"><option value="">全部</option><option value="1">普通会员</option><option value="2">球队管理员</option><option value="3">球员</option></select> </span>
	...
	<script type="text/javascript" src="${basePath}static/js/management/member/userList.js?7"></script>
</body>
</html>
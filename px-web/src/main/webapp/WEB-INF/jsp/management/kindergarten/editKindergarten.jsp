...
<body>
	<div class="edit-container"> 
		...
		<input type="hidden" name="schoolId" value="${kindergartenDTO.schoolId}">
		<ul> 
			<li><strong>名称：</strong><span><input type="text" name="name" placeholder="名称" value="${kindergartenDTO.name}"></span></li>
			<li><strong>联系人：</strong><span><input type="text" name="linkman" placeholder="联系人" value="${kindergartenDTO.linkman}"></span></li>
			<li><strong>联系电话：</strong><span><input type="text" name="mobile" placeholder="联系电话" value="${kindergartenDTO.mobile}"></span></li>
			<li><strong>座机：</strong><span><input type="text" name="tel" placeholder="座机" value="${kindergartenDTO.tel}"></span></li>
			<li><strong>地区：</strong><span><input type="text" name="areaName" placeholder="选择地区" value="${kindergartenDTO.areaName}" readonly><input type="hidden" name="areaId" value="${kindergartenDTO.areaId}"></span></li> 
			<li><strong>详细地址：</strong><span><input type="text" name="address" placeholder="详细地址" value="${kindergartenDTO.address}"></span></li>
			<li style="height:120px;"><strong>简介：</strong><span> 
				<textarea rows="1" cols="1" style="width:700px; height:80px;" name="intro" placeholder="简介">${kindergartenDTO.intro}</textarea>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/kindergarten/editKindergarten.js"></script> 
</body>
</html>
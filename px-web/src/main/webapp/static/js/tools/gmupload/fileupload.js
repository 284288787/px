...
function addMask() {
	...
	$("body").append("<div id=\"Mask\" style=\"width:100%;height:"+bodyH+"px;background-color:#333333;opacity:0.6;filter:alpha(opacity=60);_background-image:url(../../images/transBg.gif);_background-repeat:repeat;_background-color:none;position:absolute;z-index:9990;left:0px;top:0px;overflow:hidden;\"></div>");
}
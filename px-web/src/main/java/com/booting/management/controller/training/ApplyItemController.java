/** create by auto at 2019-03-12 20:59:14**/
...
public class ApplyItemController{
	...
	public Map<String, Object> list(ApplyItemDTO applyItemDTO, Integer page, Integer rows, String sord, String sidx){
		...
		PageList<ApplyItemDTO> pageList = applyItemWebService.getListForPageApplyItem(queryParam, ApplyItemDTO.class);
	...
	@RequestMapping(value = "/editBefore/{applyItemId}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	public String editBefore(@PathVariable Long applyItemId, Model model){
	  ApplyItemDTO applyItemDTO = this.applyItemWebService.getApplyItem(applyItemId);
	  model.addAttribute("applyItemDTO", applyItemDTO);
	  return "management/applyItem/editApplyItem";
	}

	@ResponseBody
	@RequestMapping(value = "/edit", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
	public ResultMessage edit(@RequestBody ApplyItemDTO applyItemDTO){
		ResultMessage resultMessage = null;
		try {
			this.applyItemWebService.updateApplyItem(applyItemDTO);
	...
	public ResultMessage add(@RequestBody ApplyItemDTO applyItemDTO){
		ResultMessage resultMessage = null;
		try {
			this.applyItemWebService.saveApplyItem(applyItemDTO);
	...
	public ResultMessage enabled(@RequestParam String ids){
		ResultMessage resultMessage = null;
		try {
			this.applyItemWebService.enabledApplyItem(ids);
	...
	public ResultMessage disabled(@RequestParam String ids){
		ResultMessage resultMessage = null;
		try {
			this.applyItemWebService.disabledApplyItem(ids);
	...
	public ResultMessage delete(@RequestParam String ids){
		ResultMessage resultMessage = null;
		try {
			this.applyItemWebService.deleteApplyItem(ids);

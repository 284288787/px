/** create by auto at 2018-01-02 14:47:02**/
...
public class KindergartenController{
	...
	@RequestMapping(value = "/chooseSchool", method = RequestMethod.GET)
	public String chooseSchool(Model model) {
		List<KindergartenDTO> schools = kindergartenWebService.getSchools();
		model.addAttribute("schools", schools);
		return "management/kindergarten/chooseSchool";
	}
	
	@ResponseBody
	@RequestMapping(value = "/list", method = RequestMethod.POST)
	public Map<String, Object> list(KindergartenDTO kindergartenDTO, Integer page, Integer rows, String sord, String sidx){
		...
		PageList<KindergartenDTO> pageList = kindergartenWebService.getListForPageKindergarten(queryParam, KindergartenDTO.class);
	...
	@RequestMapping(value = "/editBefore/{schoolId}", method = RequestMethod.GET, produces = MediaType.TEXT_HTML_VALUE)
	public String editBefore(@PathVariable Long schoolId, Model model){
		KindergartenDTO kindergartenDTO = this.kindergartenWebService.getKindergarten(schoolId);
		model.addAttribute("kindergartenDTO", kindergartenDTO);
		return "management/kindergarten/editKindergarten";
	}

	@ResponseBody
	@RequestMapping(value = "/edit", method = RequestMethod.POST, produces = "text/html;charset=UTF-8")
	public ResultMessage edit(@RequestBody KindergartenDTO kindergartenDTO){
		ResultMessage resultMessage = null;
		try {
			this.kindergartenWebService.updateKindergarten(kindergartenDTO);
	...
	public ResultMessage add(@RequestBody KindergartenDTO kindergartenDTO){
		ResultMessage resultMessage = null;
		try {
			this.kindergartenWebService.saveKindergarten(kindergartenDTO);
	...
	public ResultMessage enabled(@RequestParam String ids){
		ResultMessage resultMessage = null;
		try {
			this.kindergartenWebService.enabledKindergarten(ids);
	...
	public ResultMessage disabled(@RequestParam String ids){
		ResultMessage resultMessage = null;
		try {
			this.kindergartenWebService.disabledKindergarten(ids);
	...
	public ResultMessage delete(@RequestParam String ids){
		ResultMessage resultMessage = null;
		try {
			this.kindergartenWebService.deleteKindergarten(ids);

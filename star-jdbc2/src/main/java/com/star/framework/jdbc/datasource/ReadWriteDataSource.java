/**create by liuhua at 2016年6月8日 上午9:47:16**/
package com.star.framework.jdbc.datasource;
 ...
 * 目前实现功能
 *   一写库多读库选择功能，请参考
 *      @see com.star.framework.jdbc.datasource.ReadWriteDataSourceDecision
        @see com.star.framework.jdbc.datasource.ReadWriteDataSourceDecision.DataSourceType
 *   
 *   默认按顺序轮询使用读库
 *   默认选择写库
 *   

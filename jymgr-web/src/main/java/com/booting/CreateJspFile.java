...
public class CreateJspFile {
  ...
  private String moduleName = "franchisee";
  private String dtoName = "FranchiseeDTO";
  private String pkIdName = "memberId";
  private String controllerMappingName = "franchisee";
  private String dtoCaption = "加盟商";
    ...
    for (Map<String, String> col : editCols) {
      ...
      switch (type) {
        ...
        case "select":
          ...
          head.append("\t\t\t<li><strong>" + caption + "：</strong><span><select name=\"" + name + "\"><option value=\"\">全部</option>");

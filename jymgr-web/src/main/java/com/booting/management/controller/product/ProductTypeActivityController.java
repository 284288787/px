...
@Controller
@RequestMapping("/productTypeActivity")
public class ProductTypeActivityController {

  @Autowired
  private ProductTypeWebService productTypeWebService;

  @ResponseBody
  @RequestMapping(value = "/listActivityType", method = RequestMethod.POST)
  public Map<String, Object> list(ProductTypeDTO productTypeDTO, Integer page, Integer rows, String sord, String sidx) {
    ...
    productTypeDTO.setBusiness(ProductType.activity.getBusiness());
  ...
  @ResponseBody
  @RequestMapping(value = "/allActivityType", method = RequestMethod.POST)
  public List<ProductTypeDTO> allActivityType() {
  ...
  public String editBefore(@PathVariable Long typeId, Model model) {
    ...
    return "management/producttype/editProductTypeActivity";
  }

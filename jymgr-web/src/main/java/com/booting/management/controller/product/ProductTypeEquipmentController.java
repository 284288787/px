...
@Controller
@RequestMapping("/productTypeEquipment")
public class ProductTypeEquipmentController {

  @Autowired
  private ProductTypeWebService productTypeWebService;

  @ResponseBody
  @RequestMapping(value = "/listEquipmentType", method = RequestMethod.POST)
  public Map<String, Object> list(ProductTypeDTO productTypeDTO, Integer page, Integer rows, String sord, String sidx) {
    ...
    productTypeDTO.setBusiness(ProductType.equipment.getBusiness());
  ...
  @ResponseBody
  @RequestMapping(value = "/allEquipmentType", method = RequestMethod.POST)
  public List<ProductTypeDTO> allEquipmentType() {
  ...
  public String editBefore(@PathVariable Long typeId, Model model) {
    ...
    return "management/producttype/editProductTypeEquipment";
  }

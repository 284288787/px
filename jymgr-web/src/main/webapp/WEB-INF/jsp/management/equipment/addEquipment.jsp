...
<body>
	<div class="edit-container"> 
		...
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>设备类型：</strong></td><td><select name="typeId"></select></td>
			</tr>
			<tr>
				<td><strong>设备名称：</strong></td><td><input type="text" name="name" placeholder="设备名称" class="ipt300"></td>
			</tr>
			<tr>
				<td><strong>设备价格：</strong></td><td><input type="text" name="price" placeholder="设备价格" ></td>
			</tr>
			<tr>
			...
			<tr>
				<td><strong>设备简介：</strong></td><td><textarea rows="1" cols="1" style="width:88%; height:120px;margin: 4px 0px" name="intro" placeholder="设备简介"></textarea></td>
			</tr>
			<tr>
				<td><strong>设备详介：</strong></td><td><textarea rows="1" cols="1" style="width:90%; height:300px;margin: 4px 0px" name="content" placeholder="设备详介"></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="btnGroup2"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/equipment/addEquipment.js"></script> 
</body>
</html>
...
<body> 
	<div class="main-container" id="main-container"> 
		<div class="search-container"> 
			<form action="${basePath}" id="queryForm"> 
				<span>设备名称：<input type="text" name="name" placeholder="输入设备名称" > </span> 
				<span>设备类型：<select name="typeId"><option value="">全部</option></select> </span> 
				<span>状态：<select name="enabled"><option value="">全部</option><option value="1" >可用</option><option value="0" >禁用</option></select> </span> 
				<a onclick="equipmentHandle.query()" class="button blue">查询</a> 
				<a onclick="equipmentHandle.reset()" class="button grey">清空</a> 
			</form>
		</div> 
		<div class="data-container"> 
				<div class="btnGroup"> 
				<a onclick="equipmentHandle.addNew()" class="button grey">新增</a>
				<a onclick="equipmentHandle.enabled()" class="button blue">启用</a> 
				<a onclick="equipmentHandle.disabled()" class="button yellow">禁用</a>
				<a onclick="equipmentHandle.remove()" class="button yellow">删除</a>
				</div> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/equipment/list.js"></script>
	<script type="text/javascript">
	$(function(){
		equipmentHandle.ajax({
			url: basePath+"productTypeEquipment/allEquipmentType",

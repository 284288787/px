...
<body>
	<div class="edit-container"> 
		...
		<input type="hidden" name="equipmentId" value="${equipmentDTO.equipmentId}">
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>设备类型：</strong></td><td><select name="typeId" data="${equipmentDTO.typeId}"></select></td>
			</tr>
			<tr>
				<td><strong>设备名称：</strong></td><td><input type="text" name="name" placeholder="设备名称" class="ipt300" value="${equipmentDTO.name}"></td>
			</tr>
			<tr>
				<td><strong>设备价格：</strong></td><td><input type="text" name="price" placeholder="设备价格" value="<fmt:formatNumber value="${equipmentDTO.price/100}" pattern="#0.00"></fmt:formatNumber>"></td>
			</tr>
			<tr>
				<td width="160px"><strong>设备图片：</strong></td><td>
				<img src="${basePath}static/images/uploadBtn.png" id="uploadPicBtn"> <img style="display:none" width="70px" height="70px">
				<c:forEach items="${equipmentDTO.pictures}" var="hp">
			...
			<tr>
				<td><strong>设备简介：</strong></td><td><textarea rows="1" cols="1" style="width:88%; height:120px;margin: 4px 0px" name="intro" placeholder="设备简介">${equipmentDTO.intro}</textarea></td>
			</tr>
			<tr>
				<td><strong>设备详介：</strong></td><td><textarea rows="1" cols="1" style="width:90%; height:300px;margin: 4px 0px" name="content" placeholder="设备详介">${equipmentDTO.content}</textarea></td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="btnGroup2"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/equipment/editEquipment.js"></script> 
</body>
</html>
...
<body>
	<div class="edit-container"> 
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>设备类型：</strong></td><td>${equipmentDTO.typeName}</td>
			</tr>
			<tr>
				<td><strong>设备名称：</strong></td><td>${equipmentDTO.name}</td>
			</tr>
			<tr>
				<td><strong>设备价格：</strong></td><td><fmt:formatNumber value="${equipmentDTO.price/100}" pattern="#0.00"></fmt:formatNumber></td>
			</tr>
			<tr>
			...
			<tr>
				<td><strong>设备简介：</strong></td><td height="120px">${equipmentDTO.intro}</td>
			</tr>
			<tr>
				<td><strong>设备详介：</strong></td><td height="300px">${equipmentDTO.content}</td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="btnGroup2"> 

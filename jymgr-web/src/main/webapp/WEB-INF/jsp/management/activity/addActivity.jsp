...
<body>
	<div class="edit-container"> 
		...
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>活动类型：</strong></td><td><select name="typeId"></select></td>
			</tr>
			<tr>
				<td><strong>活动名称：</strong></td><td><input type="text" name="name" placeholder="活动名称" class="ipt300"></td>
			</tr>
			<tr>
				<td><strong>活动价格：</strong></td><td><input type="text" name="price" placeholder="活动价格" ></td>
			</tr>
			<tr>
				<td><strong>有效性：</strong></td><td>
					<input type="radio" name="state" id="state_1" value="1"><label for="state_1">永久有效</label>
					<input type="radio" name="state" id="state_2" value="2"><label for="state_2">限时有效</label>
				</td>
			</tr>
			<tr>
				<td><strong>生效时间：</strong></td><td><input type="text" name="effectiveTime" id="effectiveTime" placeholder="生效时间" class="Wdate" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'failureTime\')}',isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})"></td>
			</tr>
			<tr>
				<td><strong>失效时间：</strong></td><td><input type="text" name="failureTime" id="failureTime" placeholder="失效时间" class="Wdate" onclick="WdatePicker({minDate:'#F{$dp.$D(\'effectiveTime\')}',isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})"></td>
			</tr>
			<tr>
			...
			<tr>
				<td><strong>活动简介：</strong></td><td><textarea rows="1" cols="1" style="width:88%; height:120px;margin: 4px 0px" name="intro" placeholder="活动简介"></textarea></td>
			</tr>
			<tr>
				<td><strong>活动详介：</strong></td><td><textarea rows="1" cols="1" style="width:90%; height:300px;margin: 4px 0px" name="content" placeholder="活动详介"></textarea></td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="btnGroup2"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/activity/addActivity.js"></script> 
</body>
</html>
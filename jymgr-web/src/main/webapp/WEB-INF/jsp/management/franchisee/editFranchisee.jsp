...
<body>
	<div class="edit-container"> 
		<form action="" id="editFranchiseeForm"> 
		<input type="hidden" name="memberId" value="${franchiseeDTO.memberId}">
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>公司名称：</strong></td><td><input type="text" name="companyName" placeholder="公司名称" value="${franchiseeDTO.companyName}"></td>
			</tr>
			<tr>
				<td><strong>法人：</strong></td><td><input type="text" name="legalPerson" placeholder="法人" value="${franchiseeDTO.legalPerson}"></td>
			</tr>
			<tr>
				<td><strong>联系电话：</strong></td><td><input type="text" name="contactPhone" placeholder="联系电话" value="${franchiseeDTO.contactPhone}"></td>
			</tr>
			<tr>
				<td><strong>公司地址：</strong></td><td><input type="text" name="companyAddress" placeholder="公司地址" class="ipt400" value="${franchiseeDTO.companyAddress}"></td>
			</tr>
			<tr>
				<td><strong>签名合同：</strong></td><td><input type="button"  id="uploadCompactPathBtn" value="上传pdf文件" class="button blue">
				<a target="_blank" href="${basePath}${franchiseeDTO.compactPath}" data="${franchiseeDTO.compactPath}">合同.pdf</a>
				</td>
			</tr>
			<tr>
				<td colspan="2">
	...
	<script type="text/javascript" src="${basePath}static/js/management/franchisee/editFranchisee.js"></script> 
</body>
</html>
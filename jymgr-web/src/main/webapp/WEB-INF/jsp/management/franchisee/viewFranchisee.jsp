...
<body>
	<div class="edit-container"> 
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>公司名称：</strong></td><td>${franchiseeDTO.companyName}</td>
			</tr>
			<tr>
				<td><strong>法人：</strong></td><td>${franchiseeDTO.legalPerson}</td>
			</tr>
			<tr>
				<td><strong>联系电话：</strong></td><td>${franchiseeDTO.contactPhone}</td>
			</tr>
			<tr>
				<td><strong>公司地址：</strong></td><td>${franchiseeDTO.companyAddress}</td>
			</tr>
			<tr>
				<td><strong>签名合同：</strong></td><td><a target="_blank" href="${basePath}${franchiseeDTO.compactPath}" data="${franchiseeDTO.compactPath}">合同.pdf</a>
				</td>
			</tr>
			<tr>
				<td colspan="2">

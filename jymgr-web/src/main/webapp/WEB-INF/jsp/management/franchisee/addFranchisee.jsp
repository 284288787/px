...
<body>
	<div class="edit-container"> 
		...
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>公司名称：</strong></td><td><input type="text" name="companyName" placeholder="公司名称" ></td>
			</tr>
			<tr>
				<td><strong>法人：</strong></td><td><input type="text" name="legalPerson" placeholder="法人" ></td>
			</tr>
			<tr>
				<td><strong>联系电话：</strong></td><td><input type="text" name="contactPhone" placeholder="联系电话" ></td>
			</tr>
			<tr>
				<td><strong>公司地址：</strong></td><td><input type="text" name="companyAddress" placeholder="公司地址" class="ipt400"></td>
			</tr>
			<tr>
	...
	<script type="text/javascript" src="${basePath}static/js/management/franchisee/addFranchisee.js"></script> 
</body>
</html>
...
<body> 
	<div class="main-container" id="main-container"> 
		<div class="search-container"> 
			<form action="${basePath}" id="queryForm"> 
				...
				<span>证件号码：<input type="text" name="certificateCode" placeholder="输入证件号码" > </span> 
				<span>紧急联系人号码：<input type="text" name="emergencyContactNumber" placeholder="输入紧急联系人号码" > </span> 
				<span>是否可用：<select name="enabled"><option value="">全部</option><option value="1" >可用</option><option value="0" >禁用</option></select> </span> 
				<span>
				<a onclick="salesmanHandle.query()" class="button blue">查询</a> 
				<a onclick="salesmanHandle.reset()" class="button grey">清空</a>
				</span> 
			</form>
		</div> 
		<div class="data-container"> 
				<div class="btnGroup"> 
				<a onclick="salesmanHandle.addNew()" class="button grey">新增</a>
				<a onclick="salesmanHandle.enabled()" class="button blue">启用</a> 
				<a onclick="salesmanHandle.disabled()" class="button yellow">禁用</a>
				<a onclick="salesmanHandle.remove()" class="button yellow">删除</a>
				</div> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/salesman/list.js"></script>
</body>
</html>
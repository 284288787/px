...
<body>
	<div class="edit-container"> 
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			...
			<tr>
				<td><strong>姓名：</strong></td><td>${salesmanDTO.name}</td>
			</tr>
			<tr>
				<td><strong>手机号：</strong></td><td>${salesmanDTO.mobile}</td>
			</tr>
			<tr>
				<td><strong>性别：</strong></td><td>
				<c:if test="${salesmanDTO.sex == 1}">男</c:if>
				<c:if test="${salesmanDTO.sex == 0}">女</c:if>
				</td>
			</tr>
			<tr>
				<td><strong>出生日期：</strong></td><td><fmt:formatDate value="${salesmanDTO.birthTime}" pattern="yyyy-MM-dd"/></td>
			</tr>
			<tr>
				<td><strong>证件类型：</strong></td><td>
				<c:if test="${salesmanDTO.certificateType == 1}">身份证</c:if>
				<c:if test="${salesmanDTO.certificateType == 2}">护照</c:if>
				</td>
			</tr>
			<tr>
				<td><strong>证件号码：</strong></td><td>${salesmanDTO.certificateCode}</td>
			</tr>
			<tr>
			...
			<tr>
				<td><strong>住址：</strong></td><td>${salesmanDTO.address}</td>
			</tr>
			<tr>
				<td><strong>紧急联系人：</strong></td><td>${salesmanDTO.emergencyContact}</td>
			</tr>
			<tr>
				<td><strong>紧急联系人电话：</strong></td><td>${salesmanDTO.emergencyContactNumber}</td>
			</tr>
			<tr>
				<td><strong>紧急联系人住址：</strong></td><td>${salesmanDTO.emergencyContactAddress}</td>
			</tr>
			<tr>
				<td><strong>毕业学校：</strong></td><td>${salesmanDTO.school}</td>
			</tr>
			<tr>
				<td><strong>专业名称：</strong></td><td>${salesmanDTO.specialty}</td>
			</tr>
			<tr>
				<td><strong>工作经历：</strong></td><td height="180px">${salesmanDTO.workExperience}</td>
			</tr>
			<tr>
				<td><strong>获奖履历：</strong></td><td height="120px">${salesmanDTO.awardResume}</td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="btnGroup2"> 

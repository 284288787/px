...
<body>
	<div class="edit-container"> 
		...
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>机构名称：</strong></td><td><input type="text" name="orgName" placeholder="机构名称" ></td>
			</tr>
			<tr>
				<td><strong>机构地址：</strong></td><td><input type="text" name="orgAddress" placeholder="机构地址" class="ipt400"></td>
			</tr>
			<tr>
				<td><strong>联系人：</strong></td><td><input type="text" name="contactName" placeholder="联系人" ></td>
			</tr>
			<tr>
			...
			<tr>
				<td><strong>规模人数：</strong></td><td><input type="text" name="peopleNum" placeholder="规模人数" ></td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="btnGroup2"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/customer/addCustomer.js"></script> 
</body>
</html>
...
<body> 
	<div class="main-container" id="main-container"> 
		<div class="search-container"> 
			<form action="${basePath}" id="queryForm"> 
				<span>机构名称：<input type="text" name="orgName" placeholder="输入机构名称" > </span> 
				...
				<a onclick="customerHandle.query()" class="button blue">查询</a> 
				<a onclick="customerHandle.reset()" class="button grey">清空</a> 
			</form>
		</div> 
		<div class="data-container"> 
				<div class="btnGroup"> 
				<a onclick="customerHandle.addNew()" class="button grey">新增</a>
				<a onclick="customerHandle.enabled()" class="button blue">启用</a> 
				<a onclick="customerHandle.disabled()" class="button yellow">禁用</a>
				<a onclick="customerHandle.remove()" class="button yellow">删除</a>
				</div> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/customer/list.js"></script>
</body>
</html>
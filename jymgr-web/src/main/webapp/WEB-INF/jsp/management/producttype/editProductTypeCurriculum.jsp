...
<body>
	<div class="edit-container"> 
		<form action="" id="editProductTypeForm"> 
		<input type="hidden" name="typeId" value="${productTypeDTO.typeId}">
		<ul> 
			<li><strong>课程类型名称：</strong><span><input type="text" name="typeName" placeholder="课程类型名称" value="${productTypeDTO.typeName}"></span></li>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/producttype/editProductTypeCurriculum.js"></script> 
</body>
</html>
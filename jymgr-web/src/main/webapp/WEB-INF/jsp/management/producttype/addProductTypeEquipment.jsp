...
<body>
	<div class="edit-container"> 
		...
		<ul> 
			<li><strong>设备类型名称：</strong><span><input type="text" name="typeName" placeholder="设备类型名称" ></span></li>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/producttype/addProductTypeEquipment.js"></script> 
</body>
</html>
...
<body>
	<div class="edit-container"> 
		...
		<ul> 
			<li><strong>活动类型名称：</strong><span><input type="text" name="typeName" placeholder="活动类型名称" ></span></li>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/producttype/addProductTypeActivity.js"></script> 
</body>
</html>
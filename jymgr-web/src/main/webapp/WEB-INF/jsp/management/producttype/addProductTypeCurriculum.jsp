...
<body>
	<div class="edit-container"> 
		...
		<ul> 
			<li><strong>课程类型名称：</strong><span><input type="text" name="typeName" placeholder="课程类型名称" ></span></li>
			</span></li> 
		</ul>
		</form>
		<div class="btnGroup"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/producttype/addProductTypeCurriculum.js"></script> 
</body>
</html>
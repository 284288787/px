...
<body>
	<div class="edit-container">
		...
		<ul>
			<li><strong>设置密码：</strong><span><input type="password" id="password" name="password" placeholder="新密码"></span></li>
			<li><strong>确认密码：</strong><span><input type="password" name="password2" placeholder="确认新密码"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/user/changePassword.js"></script>
</body>
</html>
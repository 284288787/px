...
<body>
	<div class="edit-container">
		...
		<ul>
			<li><strong>企业名称：</strong><span><input type="text" name="companyName" placeholder="企业名称，必填"></span></li>
			<li><strong>发票抬头：</strong><span><input type="text" name="invoiceTitle" placeholder="发票抬头，必填"></span></li>
			...
			<li><strong>寄件地址：</strong><span><input type="text" name="address" placeholder="寄件地址"></span></li>
		</ul>
		</form>
		<div class="btnGroup">
	...
	<script type="text/javascript" src="${basePath}static/js/management/company/addCompany.js"></script>
</body>
</html>
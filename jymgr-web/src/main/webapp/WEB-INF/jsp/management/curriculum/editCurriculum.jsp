...
<body>
	<div class="edit-container"> 
		...
		<input type="hidden" name="curriculumId" value="${curriculumDTO.curriculumId}">
		<table width="80%" border="0" cellspacing="0" cellpadding="0" class="gy_table">
			<tr>
				<td width="160px"><strong>课程类型：</strong></td><td><select name="typeId" data="${curriculumDTO.typeId}"></select></td>
			</tr>
			<tr>
				<td><strong>课程名称：</strong></td><td><input type="text" name="name" placeholder="课程名称" class="ipt300" value="${curriculumDTO.name}"></td>
			</tr>
			<tr>
				<td><strong>课程价格：</strong></td><td><input type="text" name="price" placeholder="课程价格" value="<fmt:formatNumber value="${curriculumDTO.price/100}" pattern="#0.00"></fmt:formatNumber>"></td>
			</tr>
			<tr>
			...
			<tr>
				<td><strong>课程简介：</strong></td><td><textarea rows="1" cols="1" style="width:88%; height:120px;margin: 4px 0px" name="intro" placeholder="课程简介">${curriculumDTO.intro}</textarea></td>
			</tr>
			<tr>
				<td><strong>课程详介：</strong></td><td><textarea rows="1" cols="1" style="width:90%; height:300px;margin: 4px 0px" name="content" placeholder="课程详介">${curriculumDTO.content}</textarea></td>
			</tr>
			<tr>
				<td colspan="2">
					<div class="btnGroup2"> 
	...
	<script type="text/javascript" src="${basePath}static/js/management/curriculum/editCurriculum.js"></script> 
</body>
</html>
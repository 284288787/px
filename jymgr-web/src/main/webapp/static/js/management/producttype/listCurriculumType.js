...
var producttypeHandle = new ListHandle({ 
	...
	primaryKey: 'typeId',
	urls:{ 
		list: basePath+'productTypeCurriculum/listCurriculumType',//列表
		addBefore: basePath+'common/management/producttype/addProductTypeCurriculum', //添加之前 
		editBefore: basePath+'productTypeCurriculum/editBefore',//编辑之前
		enabled: basePath+'productTypeCurriculum/enabled',//启用
		disabled: basePath+'productTypeCurriculum/disabled',//禁用
		deleted: basePath+'productTypeCurriculum/delete',//删除 
	}
},{ 
